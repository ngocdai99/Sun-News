...
import {ReduxState, ReduxStoreDispatch} from '~/redux/reduxStore.ts';
import {getPosts} from '~/redux/reducer/dataReducer/fetchData.ts';
...
const HomeScreen: React.FC = () => {
  ...
  const loadingPosts = useSelector(
    (state: ReduxState) => state.data.loadingPosts,
  );
  const dataPosts = useSelector((state: ReduxState) => state.data.dataPosts);
  ...
  return (
    <ScrollView style={styles.container}>
      {Array.isArray(dataPosts) && (
          ...
          <CarouselCustom posts={dataPosts} />
